...
class VTKPARALLELSMP_EXPORT vtkSMPTransform : public vtkLinearTransform
{
 public:
  static vtkSMPTransform *New();
  vtkTypeMacro(vtkSMPTransform,vtkLinearTransform);
...
/* -> TODO convert these (from vtkLinearTransform) using kaapi */
  // Description:
