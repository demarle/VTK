...
// to VTK's major rendering classes. Grandchild classes adapt it those to
// be used by different rendering back ends.
...
protected:
  ...
  //Description:
  //internal mechanics of build, synchronize and render
