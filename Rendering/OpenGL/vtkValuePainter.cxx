...
//TODO: template MapScalars to eliminate casting to double
//TODO: make MapScalars extensible if user has a different function in mind
//TODO: make MapScalars output within a "band" so that you can do multipass for >24 bit quantities (like selection does)
//TODO: implement DrawPoints, DrawLines and DrawStrips
  ...
  bool vtkNotUsed(forceCompileOnly))
{
  ...
  bool oldSampling = glIsEnabled(vtkgl::MULTISAMPLE);
  bool oldLight = glIsEnabled(GL_LIGHTING);
