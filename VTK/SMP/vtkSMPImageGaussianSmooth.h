/*=========================================================================
  ...
  Module:    vtkSMPImageGaussianSmooth.h
...
=========================================================================*/
// .NAME vtkSMPImageGaussianSmooth - Performs a gaussian convolution.
// .SECTION Description
// vtkSMPImageGaussianSmooth implements a convolution of the input image
// with a gaussian. Supports from one to three dimensional convolutions.

#ifndef __vtkSMPImageGaussianSmooth_h
#define __vtkSMPImageGaussianSmooth_h


#include "vtkImageAlgorithm.h"

class VTK_SMP_EXPORT vtkSMPImageGaussianSmooth : public vtkImageAlgorithm
{
public:
  vtkTypeMacro(vtkSMPImageGaussianSmooth,vtkImageAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Creates an instance of vtkSMPImageGaussianSmooth with the following
  // defaults: Dimensionality 3, StandardDeviations( 2, 2, 2),
  // Radius Factors ( 1.5, 1.5, 1.5)
  static vtkSMPImageGaussianSmooth *New();
...
private:
  vtkSMPImageGaussianSmooth(const vtkSMPImageGaussianSmooth&);  // Not implemented.
  void operator=(const vtkSMPImageGaussianSmooth&);  // Not implemented.
};
